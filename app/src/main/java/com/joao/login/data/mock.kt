...
class Mock {
    ...
    private val all = AppConstants.FILTER.MODALIDADES
    private val happy = AppConstants.FILTER.TSUNAMI
    private val sunny = AppConstants.FILTER.FACE
